export const AngularFacile = [
    {
      question: "Angular est…",
      Options: ['une librairie JavaScript', 'un framework JavaScript', 'une dépendance de React', 'un nom génial pour un bar'],
      correct: 2,
      marked: -1,
    },
    {
